...
class DataTable extends StatelessWidget {
  ...
  DataTable({
    ...
    @required this.oddRowColor
        ...
        assert(columnColor != null),
        assert(evenRowColor!= null),
        assert(oddRowColor != null),
  ...
  ///background color for the column headings).
  ///
  /// Must be non-null, but may be empty.
  final Color columnColor;

  ///background color for the even row).
  ///
  /// Must be non-null, but may be empty.
  final Color evenRowColor;

  ///background color for the odd row).
  ///
  /// Must be non-null, but may be empty.
  ...
  Widget _buildDataCell({
    ...
    label = Container(
      padding: padding,
      color: isEvenRow ? evenRowColor : oddRowColor,
    ...
    for (int dataColumnIndex = 0;
      ...
      for (DataRow row in rows) {
        ...
        tableRows[rowIndex].children[displayColumnIndex] = _buildDataCell(
          ...
          isEvenRow: rowIndex % 2 == 0 ? true : false,
          onTap: cell.onTap,
